    ...
    if(isGetCarts){
        ...
        content=(
            <div className="d-flex flex-column align-items-center" style={{marginTop: '100px'}}>
                <i className="bi bi-exclamation-octagon text-danger" style={{fontSize: "40px"}}></i>
                <h1 className="text-danger mt-3">載入失敗!</h1> 
                <p className="text-muted">請確認網路連線或 API 網址是否正確?</p>
            </div>
        )
    }
